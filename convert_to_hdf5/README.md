...
1. Run ./src/process-local.sh:
   `./src/process-local.sh -d <folder where your data is> -b <bag filename> -m <meta file name>`. If you need to rebuild the underlying docker image, pass in a `-r`
2. Your HDF5 file will now be in the data folder you passed in
